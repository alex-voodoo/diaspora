...
DO NOT EDIT THIS FILE to confiture your instance of the bot, instead edit `secret.py` and override your settings there.
"""
...
# secret.py defines some essential configuration parameters, and may re-define default settings explained above
from secret import *
