...
def return_single_category() -> list:
    return [{"id": CATEGORY_1_ID, "title": CATEGORY_1_TITLE}]


def return_two_categories() -> list:
    return [{"id": CATEGORY_1_ID, "title": CATEGORY_1_TITLE},
            {"id": CATEGORY_2_ID, "title": CATEGORY_2_TITLE}]


def return_no_categories() -> list:
    return []
...
def service_get(tg_id: int, category_id: int) -> list:
